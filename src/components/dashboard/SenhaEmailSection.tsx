...
interface SenhaEmailSectionProps {
  ...
  onAddRecord?: () => void;
  onEditRecord?: (record?: BaseSenhaEmail) => void;
  showHeaderOnlyWhenEmpty?: boolean;
}

const SenhaEmailSection: React.FC<SenhaEmailSectionProps> = ({ cpfId, onCountChange, onAddRecord, onEditRecord, showHeaderOnlyWhenEmpty = true }) => {
