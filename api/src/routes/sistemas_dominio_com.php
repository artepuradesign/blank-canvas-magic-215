<?php
require_once __DIR__ . '/../controllers/SistemasDominioComController.php';
...
$controller = new SistemasDominioComController($db);
...
switch ($method) {
    ...
    case 'DELETE':
        if (preg_match('#/sistemas-dominio-com/(\d+)/?$#', $path, $matches)) {
